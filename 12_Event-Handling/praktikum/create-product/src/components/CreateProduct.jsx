...
const CreateProduct = () => {
    ...
    const bordered = document.querySelector("#product_name")
    const handleNameChange = (e) => {
        const newName = e.target.value;
        setProdName(newName);

        if (newName.length > 25) {
            bordered.style.border = "1px solid red"
            setNameWarn("* Product Name must not exceed 25 characters.");
        } else {
            setNameWarn('');
        }
    }
            ...
            <div className="container">
                ...
                <form>
                    ...
                    <div className="d-grid gap-2">
                        <button className="btn btn-primary tombol" type="button" onClick={handleSubmit}>Submit</button>
                    </div>
                </form>
            </div>
