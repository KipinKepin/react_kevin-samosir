...
const CreateProduct = () => {
    ...
    const handleNameChange = (e) => {
        ...
        if (newName.length > 25) {
            setNameWarn("* Nama Produk tidak boleh melebihi 25 karakter.");
        } else {
            setNameWarn('');
        }
    }
                    ...
                    <tbody>
                        {products.map((product, index) => (
                            <tr key={product.id}>
                                ...
                                <td>{product.price}</td>
                                <td>
                                    <button className='mr-2 btn btn-warning' onClick={() => handleEdit(product.id)}>Edit</button>
                                    <button className='mx-2 btn btn-danger' onClick={() => handleDelete(product.id)}>Hapus</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
